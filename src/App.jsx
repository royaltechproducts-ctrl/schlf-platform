...
const TC_SECTIONS = [
  {
    title:"1. About SCHLF",
    body:"Social Clique Health Link Foundation (SCHLF) is a registered health link foundation — not an insurance company, not a bank, and not a financial investment scheme. SCHLF is a technology-driven social contribution network that enables members to pool annual contributions, expand their personal networks, and receive redistributed funds as pre-emergency health credits. SCHLF is operated by RoyalTech Partnership & Investment Limited, 2B, Olawale Cole, Onitiri Avenue, Lekki Phase 1, Lagos, Nigeria.",
  },
  {
    title:"2. Legal Status and Nature of Contributions",
    items:[
      "SCHLF is a foundation and operates as a non-profit organisation under the laws of the Federal Republic of Nigeria. It is NOT an insurance company, does not offer insurance policies, and is not regulated by the National Insurance Commission (NAICOM).",
      "Contributions made to SCHLF are NOT insurance premiums, investment capital, deposits, or savings. They are voluntary annual contributions made by members to activate membership status and participate in the SCHLF network.",
      "SCHLF is NOT a financial investment scheme, pyramid scheme, Ponzi scheme, or Multi-Level Marketing (MLM) organisation. No returns on investment are promised, implied, or guaranteed.",
      "Credits distributed to members are NOT dividends, investment returns, profit-sharing, or any form of financial yield. They are contributed funds redistributed among members by measures of social clique integration and multiple network expansion algorithms — in direct proportion to the activation activity generated by each member's Health Link ID.",
      "SCHLF does not guarantee any specific level of credits, cashouts, or health emergency reserve accumulation. Credit earnings are entirely dependent on network activity and are not pre-determined or promised.",
    ],
  },
  {
    title:"3. Membership and Activation",
    items:[
      "Registration on SCHLF is free and open to any individual aged 18 years and above.",
      "Membership activation requires an annual contribution of ₦50,000 (or its equivalent in applicable local currency), which unlocks the member's unique Health Link ID on the platform.",
      "Each individual may hold only one (1) SCHLF account. Duplicate registrations using the same identity, phone number, email address, or bank account will result in immediate suspension of all associated accounts and permanent forfeiture of all accrued credits.",
      "Founding Members hold permanently active Health Link IDs with no annual contribution requirement. Founding Member status is by invitation only and is not available to the general public.",
      "SCHLF reserves the right to verify the identity of any member at any time and to suspend or terminate accounts where fraudulent, duplicate, or misleading information is detected.",
    ],
  },
  {
    title:"4. Health Link ID and Credit Structure",
    items:[
      "Upon activation, each member receives a unique Health Link ID which generates a shareable link. Members are encouraged to share this link with their personal networks.",
      "Credits of ₦10,000 are generated and distributed to a member's SCHLF Account when a third party activates a Health Link ID through the member's direct invite link.",
      "Credits of ₦10,000 are additionally distributed when a fourth party activates through the direct invitee's link (indirect link invite).",
      "Credits of ₦10,000 are further distributed when a fifth party activates through the indirect invitee's link (extended link invite).",
      "No credits are generated beyond the third level of invite circulation. The distribution structure covers direct, indirect, and extended invite chains only.",
      "Credits are generated only upon confirmed activation — pending contributions or incomplete registrations do not generate credits.",
      "There is no cap on total credits a member may accumulate. Credits accumulate indefinitely across membership renewal cycles.",
    ],
  },
  {
    title:"5. SCHLF Account Balances",
    items:[
      "Every ₦10,000 credit distributed to a member's SCHLF Account is automatically split equally: ₦5,000 to the Expendable Balance and ₦5,000 to the Reserve Balance.",
      "The Expendable Balance represents funds available for regular monthly cashout. Members may request a cashout of up to 50% of their monthly accrued Expendable Balance.",
      "The Reserve Balance is a lifetime accumulation fund accessible exclusively for verified health emergencies. It cannot be accessed for any other purpose.",
      "All cashout requests — whether regular or emergency — are subject to admin review and approval. Approval is not automatic and may require documentation.",
      "Emergency cashout requests require verifiable proof of the health emergency before approval. SCHLF reserves the right to request supporting documents including medical reports, hospital bills, or physician letters.",
    ],
  },
  {
    title:"6. Contribution Distribution Formula",
    items:[
      "Of every ₦50,000 annual member contribution received, funds are distributed as follows: three-fifths (3/5ths = ₦30,000) to the active member credit pool for distribution along invite chains; one-fifth (1/5th = ₦10,000) to the Founding Member administrative wage pool, shared equally among all Founding Members monthly; and one-fifth (1/5th = ₦10,000) retained by SCHLF administration for platform operations, maintenance, and running costs.",
      "This distribution formula may be reviewed by SCHLF trustees with 30 days' written notice to all active members.",
      "The administrative wages distributed to Founding Members are legitimate remuneration for documented trustee and administrative services rendered to the foundation — not profit distributions or investment returns.",
    ],
  },
  {
    title:"7. Health Link ID Renewal and Expiry",
    items:[
      "Regular member Health Link IDs are valid for 12 months from the date of activation. Renewal requires a fresh annual contribution of ₦50,000.",
      "SCHLF will send an email reminder to the member's registered email address 7 days before the Health Link ID expires.",
      "There is no grace period after expiry. A Health Link ID that has not been renewed will be set to inactive status immediately upon expiry.",
      "An inactive Health Link ID does not generate credits. Any activations that occur through the member's link while the ID is inactive are permanently lost and cannot be recovered retroactively.",
      "All credit channels (direct, indirect, extended) are preserved in full during inactive status. Upon renewal, the member's link becomes active again and resumes generating credits from new activations.",
    ],
  },
  {
    title:"8. Prohibited Conduct",
    items:[
      "Creating more than one SCHLF account, whether under the same or different identities.",
      "Providing false, misleading, or unverifiable personal information during registration or at any time thereafter.",
      "Using automated tools, bots, scripts, or any artificial means to generate fake activations or manipulate credit distributions.",
      "Misrepresenting SCHLF as an insurance company, investment scheme, or financial institution to prospective members.",
      "Soliciting contributions or promising guaranteed returns to prospective members in ways inconsistent with these Terms.",
      "Any conduct that constitutes fraud, impersonation, money laundering, or a violation of the laws of the Federal Republic of Nigeria.",
    ],
  },
  {
    title:"9. Disclaimer of Insurance and Investment",
    body:"SCHLF expressly disclaims any association with insurance, investment, or financial services. Membership in SCHLF does not constitute the purchase of an insurance policy, a financial investment, or a guaranteed savings plan. SCHLF makes no representations or warranties regarding the level of credits a member will earn, the amount of cashouts a member will receive, or the adequacy of any accumulated reserve to meet any specific health cost. All participation in SCHLF is voluntary and at the member's own risk and judgement.",
  },
  {
    title:"10. Limitation of Liability",
    body:"SCHLF and its trustees, officers, and administrators shall not be liable for any loss, damage, or claim arising from a member's participation in the platform, failure to renew membership, loss of credits during inactive periods, rejection of cashout requests, or any health emergency that arises regardless of reserve balance. SCHLF is a contributor network and does not guarantee health outcomes or financial adequacy for any specific health situation.",
  },
  {
    title:"11. Governing Law",
    body:"These Terms and Conditions are governed by the laws of the Federal Republic of Nigeria. Any disputes shall first be referred to the SCHLF trustees for internal resolution before recourse to any external mechanism.",
  },
  {
    title:"12. Contact",
    body:"Social Clique Health Link Foundation (SCHLF) | 2B, Olawale Cole, Onitiri Avenue, Lekki Phase 1, Lagos, Nigeria | Email: schlf2026@gmail.com | Phone: +234 806 163 1222",
  },
];
...
export default function App() {
  ...
  const handleRegister = async () => {
    ...
    if(!tcAccepted){ setRegErrors({general:"Please read and accept the SCHLF Terms & Conditions before registering."}); return; }
    ...
    <>
        ...
        <>
          <div className="hero">
            ...
            <div className="hero-btns">
              <button className="btn btn-gold btn-lg" onClick={()=>{setTcAccepted(false);setShowTC(true);}}>Register Free Today</button>
          ...
          <div className="cta-section">
            ...
            <button className="btn btn-gold btn-lg" onClick={()=>{setTcAccepted(false);setShowTC(true);}}>Register Free Now</button>
          </div>
          ...
          <div className="footer">
            ...
            <div style={{marginTop:12,fontSize:11,opacity:.5}}>
              © 2026 {COMPANY}. All rights reserved. SCHLF is a health link foundation and is not an insurance company, financial institution, or investment scheme.
            </div>
            <div style={{marginTop:8,fontSize:12}}>
              <button style={{background:"none",border:"none",color:"rgba(255,255,255,0.6)",
                cursor:"pointer",textDecoration:"underline",fontSize:12}}
                onClick={()=>{setTcAccepted(false);setShowTC(true);}}>
                Terms & Conditions
              </button>
              {" | "}
              <button style={{background:"none",border:"none",color:"rgba(255,255,255,0.6)",
      ...
      {showTC && (
        <div style={{padding:"40px 24px",background:"#F0F7F7",minHeight:"80vh"}}>
          <div style={{background:WHITE,borderRadius:16,padding:40,maxWidth:800,margin:"0 auto",
            boxShadow:"0 4px 32px rgba(11,110,110,0.08)"}}>
            <button onClick={()=>setShowTC(false)} style={{background:"none",border:"none",
              color:MUTED,cursor:"pointer",fontSize:13,marginBottom:16}}>← Back</button>
            <div style={{textAlign:"center",marginBottom:24}}>
              <div style={{fontSize:22,fontWeight:900,color:TEAL_DARK,marginBottom:4}}>
                Terms & Conditions
              </div>
              <div style={{fontSize:13,color:MUTED}}>
                Social Clique Health Link Foundation (SCHLF)<br/>
                Operated by RoyalTech Partnership & Investment Limited
              </div>
            </div>
            {/* Legal Disclaimer Banner */}
            <div style={{background:"#FEE2E2",border:"2px solid #FCA5A5",borderRadius:10,
              padding:16,marginBottom:24,fontSize:13,color:ERROR,lineHeight:1.8}}>
              <strong>⚠️ Important Legal Notice:</strong> SCHLF is NOT an insurance company, insurance plan,
              financial investment scheme, pyramid scheme, or Multi-Level Marketing (MLM) organisation.
              Contributions are NOT insurance premiums, investment capital, or savings deposits.
              Credits distributed are NOT dividends, returns on investment, or profit-sharing —
              they are contributed funds redistributed through a social clique and multiple network
              integration algorithm. Participation is voluntary and entirely at your own discretion.
            </div>
            {TC_SECTIONS.map((sec,i)=>(
              <div key={i} style={{marginBottom:20,paddingBottom:20,
                borderBottom:i<TC_SECTIONS.length-1?"1px solid #F3F4F6":"none"}}>
                <div style={{fontWeight:800,fontSize:14,color:TEAL_DARK,marginBottom:8}}>
                  {sec.title}
                </div>
                ...
                {sec.items&&sec.items.map((item,j)=>(
                  <div key={j} style={{display:"flex",gap:10,marginBottom:8,fontSize:13,color:"#374151",lineHeight:1.75}}>
                    <span style={{color:TEAL,fontWeight:700,flexShrink:0}}>{i+1}.{j+1}</span>
                    <span>{item}</span>
                  </div>
                ))}
              </div>
            ))}
            <div style={{background:TEAL_LIGHT,borderRadius:10,padding:16,
              display:"flex",alignItems:"center",gap:12,marginTop:8}}>
              <input type="checkbox" id="tc_check" style={{width:18,height:18,cursor:"pointer"}}
                checked={tcAccepted} onChange={e=>setTcAccepted(e.target.checked)}/>
              <label htmlFor="tc_check" style={{fontSize:13,color:TEAL_DARK,cursor:"pointer",lineHeight:1.6}}>
                I have read and agree to the SCHLF Terms & Conditions.
              </label>
            </div>
            <button className="btn btn-teal" style={{width:"100%",marginTop:16,fontSize:15,padding:14}}
              disabled={!tcAccepted}
      ...
      {view==="register" && (
        <div style={{padding:"40px 24px",background:"#F0F7F7",minHeight:"80vh"}}>
          <div className="card" style={{maxWidth:560,margin:"0 auto"}}>
            ...
            {regErrors.general&&<div style={{background:"#FEE2E2",borderRadius:8,padding:12,fontSize:13,color:ERROR,marginBottom:12}}>{regErrors.general}</div>}
            ...
            <div style={{background:TEAL_LIGHT,border:"1px solid #A8D8D8",borderRadius:8,
              padding:14,marginBottom:16,display:"flex",alignItems:"flex-start",gap:12}}>
              <input type="checkbox" id="reg_tc" style={{width:18,height:18,marginTop:2,
                cursor:"pointer",flexShrink:0}}
                checked={tcAccepted} onChange={e=>setTcAccepted(e.target.checked)}/>
              <label htmlFor="reg_tc" style={{fontSize:13,color:TEAL_DARK,cursor:"pointer",lineHeight:1.6}}>
                I have read and agree to the{" "}
                <button type="button" style={{background:"none",border:"none",color:TEAL,
                  fontWeight:700,cursor:"pointer",fontSize:13,padding:0,textDecoration:"underline"}}
                  onClick={()=>setShowTC(true)}>
                  SCHLF Terms & Conditions
                </button>.
                SCHLF is not an insurance plan, investment scheme, or MLM.
                Credits are contributed funds redistributed through network algorithm — not investment returns.
              </label>
            </div>
            <button className="btn btn-teal" style={{width:"100%"}}
              disabled={!tcAccepted}
              onClick={handleRegister}>Register Free</button>
          </div>
        </div>
      )}
